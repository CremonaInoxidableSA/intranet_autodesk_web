...
export const GraficoTortaUso = forwardRef<
  ChartJS<"pie"> | undefined,
  Propiedades
  ...
  return (
    <div className="flex justify-center">
      <div style={{ maxWidth: 340, width: "100%" }}>
        <Pie
          ref={ref as React.ForwardedRef<ChartJS<"pie"> | undefined>}
          data={datosTorta}
          options={{
            responsive: true,
            plugins: {
              legend: {
                ...
                onClick: (
                  ...
                  const hidden = (datasetMeta.hidden || {}) as Record<
                    number,
                    boolean
                  >
                  ...
                  if (isHidden) {
                    ...
                    const datosActivos = datasetMeta.data.filter(
                      (_: unknown, i: number) => hidden[i] !== true
                    ).length
                    if (datosActivos <= 2) {
                      return false
                    }
